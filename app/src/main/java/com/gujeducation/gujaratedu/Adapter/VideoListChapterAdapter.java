...
public class VideoListChapterAdapter extends RecyclerView.Adapter<VideoListChapterAdapter.MyViewHolder> {

    private final AppCompatActivity activity;
    public boolean error = false;
    ArrayList<VideoChapter> listVideos = new ArrayList();
    Functions mFunction;
    Intent intent;
    private int mNumColumns = 0;

    public VideoListChapterAdapter(AppCompatActivity activity, ArrayList<VideoChapter> listVideos) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        final VideoChapter videoList = listVideos.get(position);
