...
public class CalenderAdapter extends RecyclerView.Adapter<CalenderAdapter.MyViewHolder> {
    ...
    public CalenderAdapter(AppCompatActivity activity, ArrayList<Calender> listCalender) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.btnView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(activity, CalenderEditionScreen.class);
                intent.putExtra("calenderId", calenderList.getCalendarId());
